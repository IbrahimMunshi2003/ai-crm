...
class Enum(String, SchemaType, Emulated, TypeEngine[Union[str, enum.Enum]]):
    ...
    alternatively a PEp-635-compliant enumerated class.  For the purposes
    ...
    with a PEp-635-compliant enumerated class and  returns a list of string
    ...
    def __init__(self, *enums: Union[str, Type[enum.Enum]], **kw: Any) -> None:
        ...
        :param \*enums: either exactly one PEp-635 compliant enumerated type
        ...
        :param name: The name of this type. This is required for PostgreSQL
           ...
           the type and/or a table that uses it. If a PEp-635 enumerated
        ...
        :param values_callable: A callable which will be passed the PEp-635
