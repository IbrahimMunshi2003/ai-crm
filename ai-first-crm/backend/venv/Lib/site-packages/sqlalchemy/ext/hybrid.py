...
Using ``inplace`` to create pep-684 compliant hybrid properties
---------------------------------------------------------------
...
:meth:`.hybrid_property.expression` for the ``Interval.radius`` descriptor::
    ...
    # correct use, however is not accepted by pep-684 tooling
...
a single decorator under one name::
    ...
    # correct use which is also accepted by pep-684 tooling
